...
$ppid=$_GET['pp_id'];
$stmt2=$admin->ret("SELECT * FROM `ps_payment` inner join `prescription` on prescription.ps_id=ps_payment.ps_id inner join `customer` on customer.c_id=prescription.c_id where ps_payment.pp_id='$ppid'");
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary text-center rounded p-4">
                            ...
                            <div class="mt-2 d-flex text-center align-items-center justify-content-center" style="gap:10px">
                                <div class="w-50">
                                    <input type="hidden" name="id" value="<?php echo $ppid; ?>" >
                                ...
                                <div>
                                    <input type="submit" name="okay" class="btn btn-danger">
                                </div>
                            </div>
                            </form>
                        </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="p-3">
                                    <div class="d-flex">
                                        ...
                                        <input readonly type="text" name="name" required class="form-control bg-dark" value="<?php echo $row2['c_name'] ?>">
                                    </div>

                                    <div class="d-flex mt-3">
                                        <label class="w-50 mt-2">Total Amount</label>
                                        <input readonly type="text" name="cp" required class="form-control bg-dark" value="<?php echo $row2['pp_amount'] ?>">
                                    </div>
                                    <div class="d-flex mt-3">
                                        <label class="w-50 mt-2">Transaction ID</label>
                                        <input readonly type="text" name="cp" required class="form-control bg-dark" value="<?php echo $row2['pp_tid'] ?>">
                                    </div>
