...
$oid=$_GET['o_id'];
$stmt2=$admin->ret("SELECT * FROM `order` inner join `medicine` on medicine.m_id=order.m_id inner join `customer` on customer.c_id=order.c_id inner join `purchase` on purchase.pr_id=medicine.pr_id where `o_id`='$oid'");
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary text-center rounded p-4">
                            ...
                            <form action="controller/order.php" method="post" class="signin-form" enctype="multipart/form-data">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="p-3">
                                    <div class="d-flex">
                                        ...
                                        <input readonly type="text" name="np" required class="form-control bg-dark" value="<?php echo $row2['m_title'] ?>">
                                    </div>
