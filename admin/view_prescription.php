                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <img src="../customer/controller/<?php echo $row2['ps_file']; ?>" alt="a" style="width:500px;height:500px;overflow:hidden;object-fit:cover">
                            ...
                            <div class="mt-2 text-center align-items-center justify-content-center" style="gap:10px">
                                <div>
                                    ...
                                    <select class="form-control bg-dark" required name="status">
                                        <option value="" hidden><?php echo $row2['ps_status'] ?></option>
                                ...
                                <div class="mt-2">
                                    <input type="number" min="0" value="<?php echo $row2['ps_amount'] ?>" name="amnt" class="form-control" placeholder="Total Amount" required >
                                </div>
                                <div class="mt-2">
                                    
                                    <textarea class="form-control" placeholder="message" required name="msg"><?php echo $row2['ps_response'] ?></textarea>
                                </div>
                                <div>
