        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="homepage.php">Home</a> <span>|</span> <a href="upload.php">Prescription</a>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-top text-center">
                        ...
                        <p>
                        <font size="4" face="calibri" color="BLACK">Customer are able to upload thier prescription by completing all required fields provided belows.</font></p>
                    </div>
                </div>
            </div>
            <?php
                                    $total=0;
                                    $gtotal=0;
                                    $stmt=$admin->ret("SELECT * FROM `cart` INNER JOIN `medicine` ON medicine.m_id=cart.m_id WHERE cart.c_id='$cid'");
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 align-self-center">
                    <div class="appointment-form text-center mt-5 mt-lg-0">
                        <h3 class="mb-5">Upload prescription</h3>
                        <form action="controller/prescription.php" method="post" enctype="multipart/form-data">
                            <div class="d-flex" style="gap:10px">
                                <div class="form-group w-100">
                                    <input type="text" placeholder="Patient Name" name="name" required>
                                </div>
                                <div class="form-group w-100">
                                    <input type="number" min="0" placeholder="Age" name="age" required>
                                </div>
                            </div>
                            <div class="d-flex" style="gap:10px">
                                <div class="form-group d-flex w-100" style="gap:20px">
                                    <h4 class="mt-2 fw-bolder text-light">Gender</h4>
                                   <label class="d-flex" style="gap:5px">
                                        <input type="radio" name="gender" value="male" class="mb-1"required >
                                        <h4 class="mt-2 text-light fw-bolder">Male</h4>
                                    </label>
                                    <label class="d-flex" style="gap:5px">
                                      <input type="radio" name="gender" value="female" />
                                      <h4 class="mt-2 text-light fw-bolder">Female</h4>
                                    </label>
                                    <label class="d-flex" style="gap:5px">
                                      <input type="radio" name="gender" value="other" />
                                      <h4 class="mt-2 text-light fw-bolder">Other</h4>   
                                    </label>

                                </div>
                                <div class="form-group w-100">
                                    <input type="file" placeholder="Pin" name="file" class="form-control p-1" required>
                                </div>
                            </div>
                            <div class="d-flex" style="gap:10px">
                                ...
                                <div class="form-group w-100">
                                    <textarea name="message" cols="20" rows="7"  placeholder="Type description here" required></textarea>
                                </div>
                            </div>
