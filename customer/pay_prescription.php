...
$psid=$_GET['ps_id'];
$stmt2=$admin->ret("SELECT * FROM `prescription` where `ps_id`='$psid'");
$row2=$stmt2->fetch(PDO::FETCH_ASSOC);
$gtotal=$row2['ps_amount'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section class="banner-area other-page">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Payment</h1>
                    <a href="homepage.php">Home</a> <span>|</span> <a href="prescriptions.php">Precriptions</a>
                        ...
                        <form action="controller/pay.php" method="post">
                            ...
                            <div class="d-flex" style="gap:10px">
                                <div class="form-group w-100">
                                    <input type="hidden" placeholder="Total Amount" value="<?php echo $psid; ?>" readonly name="id" required>
                            ...
                            <button type="submit" name="pay" class="template-btn">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
