        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="orders.php">Orders</a> <span>|</span> <a href="pay.php">Payment</a>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-top text-center">
                        <h2>Order Now</h2>
                        <p>
                        <font size="4" face="calibri" color="BLACK">Customer are able to place thier order by completing all required fields provided below.</font></p>
                    </div>
                </div>
            </div>
            <?php
                    ...
                    <div class="appointment-form text-center mt-5 mt-lg-0">
                        ...
                        <form action="controller/order.php" method="post">
                            <div class="d-flex" style="gap:10px">
                                ...
                                <div class="form-group w-100">
                                    <input type="text" placeholder="City" name="ct" required>
                                </div>
                            </div>
                            <div class="d-flex" style="gap:10px">
                                <div class="form-group w-100">
                                ...
                                <div class="form-group w-100">
                                    <input type="number" pattern="[0-9]{6}" placeholder="Pin" name="pin" required>
                                </div>
                            </div>
                            <div class="d-flex" style="gap:10px">
                                <div class="form-group w-100">
                            ...
                            <button type="submit" name="order" class="template-btn">Order</button>
                        </form>
                    </div>
                </div>
            </div>
